...
1. **What an AI receptionist does** — REVERTED 2026-07-01. Final pick: **"AI Answering Service for Small Businesses | Overview of Upfirst"** — Upfirst — **6:30** — https://www.youtube.com/watch?v=AUEr1jPJsi8 — feature/overview walkthrough, no dedicated pricing/cost chapter (per the visible chapter list: call summaries, AI customization). Replaces "AI Receptionists for Small Businesses Explained (Full Breakdown)" (SixFlow Automations, `0_TQV5tfFds`, 7:40), pulled because its "full breakdown" included a raw per-minute wholesale cost figure that ended up verbatim in a flashcard — exposing Ohvara's markup/margin to appointment setters, which Brayden does not want them to know. **Brayden to transcribe and flag/skip any pricing or cost-of-service mention** he hits in this video too, same reason — the topic itself (what it does, why it matters) is fine, only $-figures on the vendor's own cost structure are off-limits.
