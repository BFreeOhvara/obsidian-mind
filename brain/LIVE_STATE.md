...
**Update 2026-07-29:** [[Prompt 383]]'s icon fix is shipped (`fc9644e`) — the 17 preview rows seeded below will now render with distinct per-type icons instead of the single duplicated one Brayden saw. Still needs Brayden's own login to actually review and cull the list; CC's harness check only confirmed the icons render distinctly, not his keep/cut decision.
