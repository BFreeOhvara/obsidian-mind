...
2. What three things must you establish in the first four seconds of a call?
   A) Name, company, and price
   B) Sharp/on the ball, enthusiastic, and perceived as an expert ✅
...
4. What three things make up charisma, per the video?
   ...
   D) Volume, speed, and eye contact only

## Mini-Quiz 3 — The discovery script

1. What's the simplest follow-up technique when a prospect uses an emotional word like "stressed"?
   A) Change the subject right away
   B) Repeat the word back as a question — "stressed?" ✅
   C) Apologize for bringing it up
   D) Offer a discount immediately

2. What does asking "how long has that been going on for?" accomplish?
...
4. What's the overall goal of these clarifying and probing questions?
   ...
   D) Get the prospect to reveal the real problem and feel the emotion behind it ✅
...
2. What tone does the video recommend when greeting the gatekeeper?
   ...
   D) Reading a long scripted introduction

3. What's a key mistake to avoid once the gatekeeper starts asking questions?
   A) Saying your own name
   B) Asking for the owner by name
   C) Over-explaining yourself instead of staying brief ✅
   D) Speaking too quietly

4. What's an effective response if the gatekeeper asks who's calling or why?
   A) A full explanation of your product
   B) A brief reply like "is he not there? Should I call back later?" ✅
   C) Hanging up
   D) Asking for their manager instead
...
2. What's the purpose of asking a "consequence question" when a prospect brushes you off?
   A) To confirm a meeting time
   B) To deframe the prospect and get them thinking about what happens if they don't act ✅
   C) To ask for payment information
   D) To politely end the call

3. Why might you intentionally use a "concerned" tone when challenging an objection?
   A) It makes you sound unsure of your product
   B) It has no real effect either way
   C) It seeds doubt that the prospect might be missing something, lowering their guard ✅
   D) It signals the call is ending

4. What is the "identity frame" technique meant to do?
   A) Compare your price to a competitor's
   B) Get the prospect to avoid identifying with people who keep delaying and never fix the problem ✅
...
1. Per the video, when is it okay to be more assertive about booking the appointment?
   ...
   D) Never — always let them decide

2. What does "assume the appointment" mean?
   A) Always double-confirm before booking
   B) Ask permission before every step
...
4. Why does the video recommend asking for a small, specific amount of time, like "two minutes"?
   ...
   D) It's a small ask that makes it easy for the prospect to say yes ✅
...
4. Which of these is listed as one of the video's core takeaways?
   ...
   D) Make calls only in the afternoon
...
5. What does effective tonality give you in a conversation, per the video?
   ...
   D) It's only relevant in person, not on the phone

6. Which of these is NOT one of the three things to establish in your first four seconds?
   A) Sharp/on the ball
   B) Enthusiastic
...
11. What does asking "what's causing this to happen?" help uncover?
    A) Their budget range
    B) Their preferred callback time
